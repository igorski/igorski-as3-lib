package nl.igorski.lib.definitions
{
    ...
    public class Fonts
    {
         ...
         */
        public static function mapStyle( styleName:String, fontName:String, fontSize:Number, fontColor:uint, bold:Boolean = false ):void
        {
            if ( INSTANCE._fontMappings == null )
                INSTANCE._fontMappings = new Dictionary();

            INSTANCE._fontMappings[ styleName ] = new TextFormat( fontName, fontSize, fontColor, bold );
        }
